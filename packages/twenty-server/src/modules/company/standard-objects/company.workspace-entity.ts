...
import { type SocialMediaAccountWorkspaceEntity } from 'src/modules/social-media-account/standard-objects/social-media-account.workspace-entity';
...
export class CompanyWorkspaceEntity {
  ...
  socialMediaAccounts: EntityRelation<SocialMediaAccountWorkspaceEntity[]>;
}
